...
- Write using [Pandoc](https://pandoc.org) markdown, including equations, citations, crossrefs, figure panels, callouts, advanced layout, and more.\above
-->

- 使用 [Jupyter](https://jupyter.org) 笔记本或在您喜欢的编辑器中使用纯文本 Markdown 进行创作。
